...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.wong.kmall.demo.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("kmall-demo")
                .description("kmall-demo模块接口")
                .contact(new Contact("KaKinWong", "", ""))
                .version("1.0")
                .build();
    }
